...
class WorkoutView(APIView):
    ...
    def getWorkout(request,pk):
        ...
        serializer = workoutSerializer(request.user, many=False)
        return Response(serializer.data)
...
def getExercises(request,workoutId):
    exercises = Exercise.objects.filter(workout_id=workoutId)
...
def getSets(request, exerciseId,workoutId):
    sets = Set.objects.filter(exercise_id=exerciseId)
